  // ══════════════════════════════════════════════════
        ...
        class Particle {
            ...
            init(rand) {
                ...
                this.a = Math.random() * .12 + .17; // Reduced opacity for atmospheric feel
            }
            tick() {
        ...
        const words = ['Full Stack Developer', 'Creative Problem Solver', 'Exploring Blockchain', 'JWT-based Authentication & Authorization', 'Open Source Contributor', 'Protected Routes & Middleware','Problem Solving (DSA Basics)'];
